...
| 3.5 | [Social and Profile Enrichment](07-social-and-profile-enrichment.md) | Lets a user optionally import facts from profiles they explicitly choose, improving their profile and networking preparation without broad collection. | It depends on the trust, preference, and consent foundations established by the earlier phases. |
